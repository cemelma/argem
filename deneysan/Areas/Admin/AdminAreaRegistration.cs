...
namespace deneysan.Areas.Admin
{
    public class AdminAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute("project_iptal", "yonetim/iptaledilenprojeler", new { action = "IptalEdilenProjeler", Controller = "Project" });
            context.MapRoute("project_iptallang", "yonetim/iptaledilenprojeler/{lang}", new { action = "IptalEdilenProjeler", Controller = "Project" });
            ...
            context.MapRoute("projectteklifpdf", "yonetim/projeteklifpdf/{id}", new { action = "ProjectDetailPdf", Controller = "Project" });
            context.MapRoute("projectteklifsavepdf", "yonetim/SavePdf", new { action = "SavePdf", Controller = "Project" });
