                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.response == "success") {
                            ...
                            $("#contactSuccess").removeClass("hidden"); $("#contactError").addClass("hidden");
                            ...
                            //if (($("#contactSuccess").position().top - 80) < $(window).scrollTop()) { $("html, body").animate({ scrollTop: $("#contactSuccess").offset().top - 80 }, 300); }
                        } else 
                        {
                            $("#contactError").removeClass("hidden"); $("#contactSuccess").addClass("hidden");
                            $("#contactForm #name, #contactForm #email, #contactForm #subject, #contactForm #message").val("").blur().closest(".control-group").removeClass("success").removeClass("error");
                            $("#contactForm").css('visibility', 'hidden');
                            //$('.alert-error').removeClass("hidden");
                            //$("#contactError").removeClass("hidden"); $("#contactSuccess").addClass("hidden");
                            //$("#contactForm #name, #contactForm #email, #contactForm #subject, #contactForm #message").blur().closest(".control-group").removeClass("success").removeClass("error");
                            //if (($("#contactError").position().top - 80) < $(window).scrollTop()) { $("html, body").animate({ scrollTop: $("#contactError").offset().top - 80 }, 300); }
                        }
                    }
                });
            }, rules: { name: { required: true }, email: { required: true, email: true }, subject: { required: true }, message: { required: true } }, highlight: function (element) { $(element).closest(".control-group").removeClass("success").addClass("error"); }, success: function (element) { $(element).closest(".control-group").removeClass("error").addClass("success"); }
        });
    }
